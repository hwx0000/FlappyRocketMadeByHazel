...
namespace Hazel
{
	...
	void Renderer2D::DrawQuad(const glm::vec2& position, float rotatedAngle, const glm::vec2& size, std::shared_ptr<Texture> tex)
	{
		DrawQuad(glm::vec3(position.x, position.y, 0), rotatedAngle, size, tex);
	}
